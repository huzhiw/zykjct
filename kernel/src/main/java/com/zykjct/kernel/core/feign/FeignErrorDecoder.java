...
import com.zykjct.kernel.core.exception.ApiServiceException;
import com.zykjct.kernel.core.exception.ServiceException;
...
/**
 * @description: feign错误解调器(错误转换为ServiceException)
 * @author: huzhiwen
 * @create: 2019-01-31 14:52
 **/
...
public class FeignErrorDecoder implements ErrorDecoder {
    ...
    public Exception decode(String methodKey, Response response) {
         ...
         */
        if (StringUtils.isNotBlank(exceptionClazz)) {
